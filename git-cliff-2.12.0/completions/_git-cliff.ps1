...
Register-ArgumentCompleter -Native -CommandName 'git-cliff' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'git-cliff' {
            ...
            [CompletionResult]::new('--skip-tags', '--skip-tags', [CompletionResultType]::ParameterName, 'Sets the tags to skip in the changelog')
            ...
            [CompletionResult]::new('--azure-devops-token', '--azure-devops-token', [CompletionResultType]::ParameterName, 'Sets the Azure DevOps API token')
            [CompletionResult]::new('--azure-devops-repo', '--azure-devops-repo', [CompletionResultType]::ParameterName, 'Sets the Azure DevOps repository')
            ...
            [CompletionResult]::new('--offline', '--offline', [CompletionResultType]::ParameterName, 'Disable network access for remote repositories')
            break
        }
    })
