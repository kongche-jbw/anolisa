...
complete -c git-cliff -l skip-tags -d 'Sets the tags to skip in the changelog' -r
...
complete -c git-cliff -l azure-devops-token -d 'Sets the Azure DevOps API token' -r
complete -c git-cliff -l azure-devops-repo -d 'Sets the Azure DevOps repository' -r
...
complete -c git-cliff -l offline -d 'Disable network access for remote repositories'
