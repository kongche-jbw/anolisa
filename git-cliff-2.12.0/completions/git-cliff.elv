...
set edit:completion:arg-completer[git-cliff] = {|@words|
    ...
    var completions = [
        &'git-cliff'= {
            ...
            cand --skip-tags 'Sets the tags to skip in the changelog'
            ...
            cand --azure-devops-token 'Sets the Azure DevOps API token'
            cand --azure-devops-repo 'Sets the Azure DevOps repository'
            ...
            cand --offline 'Disable network access for remote repositories'
        }
    ]
    $completions[$command]
}
